...
which is more expressive, being able to model proper types, numbers and action costs \cite{aeronautiques1998pddl}.
...
The experiment was performed on a Macbook with M1 chip while it was connected to power, 
with Lean running the compiled algorithms on the problem 100 times.
All datapoints in Figure 2 higher than 500ms were experiments that were only run once.
