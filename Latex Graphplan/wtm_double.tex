...
the problem operates on are predicates on zero or more variables, and all predicates that aren't known to be true 
...
must not be set for the action to be possible, a set of variables that is set to 
...
Proof irrelevance: all proofs of the same statement are equal
\subsection{Proving statements about Graphplan in Lean}
